...
#| label: data_get_api
#| eval: false
data_get_api_files <- here::here(
  "Scripts",
  "ProcessingScripts",
  "DataCollectionScripts",
  c("_data_api.qmd", "_data_api.R"))
quarto::quarto_render(data_get_api_files[1], quiet = TRUE)
targets::tar_make(script = data_get_api_files[2], store = "_stores/_data_api")
```
...
#| label: data_process
#| eval: false
data_process_files <- here::here(
  "Scripts",
  "ProcessingScripts",
  "DataCollectionScripts",
  c("_data_process.qmd", "_data_process.R"))
quarto::quarto_render(data_process_files[1], quiet = TRUE)
targets::tar_make(script = data_process_files[2], store = "_stores/_data_process")
```
