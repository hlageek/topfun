...
**Number of rows**: `r nrow(data_csf)`

**Number of columns**: `r ncol(data_csf)`

**Number of unique projects**: `r length(unique(data_csf$project_code))`

## Dataset preview

```{r head_view, echo=FALSE, message=FALSE, warning=FALSE}
