...
```{r, engine='targets', label='pin_board', tar_globals = TRUE}
    # Establish data board
agency_data_board <- pins::board_url(c(
  data_csf =
...
# Establish topic model board
topic_models_board <- pins::board_url(c(
  topic_models =
...
```{r, engine='targets', label='data_documentation'}
